...
//      // yeha per hum sare ke sare data extract kiya hun 
...
//     //  } // OR // koi empty string pass nhi kara na check kiya 
//     if (
...
const getWatchHistory = asyncHandler(async (req,res)=> {
   ...
   .json(
      new ApiResponse(
         200,
         user[0].WatchHistory,
         "watech history fetch successfully "
      )
   )
})
export {registerUser,
